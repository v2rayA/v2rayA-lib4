...
import (
	...
	"github.com/v2rayA/v2rayA-lib4/common/netTools/netstat"
	"github.com/v2rayA/v2rayA-lib4/common/netTools/ports"
	"github.com/v2rayA/v2rayA-lib4/conf"
	"github.com/v2rayA/v2rayA-lib4/core/coreObj"
	"github.com/v2rayA/v2rayA-lib4/core/iptables"
	"github.com/v2rayA/v2rayA-lib4/core/serverObj"
	"github.com/v2rayA/v2rayA-lib4/core/specialMode"
	"github.com/v2rayA/v2rayA-lib4/core/v2ray/asset"
	"github.com/v2rayA/v2rayA-lib4/core/v2ray/service"
	"github.com/v2rayA/v2rayA-lib4/core/v2ray/where"
	"github.com/v2rayA/v2rayA-lib4/db/configure"
	"github.com/v2rayA/v2rayA-lib4/pkg/plugin"
	...
	case configure.WhitelistMode:
		...
		t.Routing.Rules = append(t.Routing.Rules,
			coreObj.RoutingRule{
				...
				OutboundTag: "proxy",
				InboundTag:  deepcopy.Copy(inbounds).([]string),
				// https://github.com/v2rayA/v2rayA-lib4/issues/285
...
func (t *Template) appendDNSOutbound() {
	t.Outbounds = append(t.Outbounds, coreObj.OutboundObject{
		Tag:      "dns-out",
		Protocol: "dns",
		// Fallback DNS for non-A/AAAA/CNAME requests. https://github.com/v2rayA/v2rayA-lib4/issues/188
		...
		if couldListenLocalhost, _ := specialMode.CouldLocalDnsListen(); couldListenLocalhost {
			...
			t.Inbounds = append(t.Inbounds, coreObj.Inbound{
				...
				Settings: &coreObj.InboundSettings{
					...
					// related commit: https://github.com/v2rayA/v2rayA-lib4/commit/ecbf915d4be8b9066955a21059519266bcca6b92
					Address: "2.0.1.7",
					Port:    53,
				},
				Tag: "dns-in",
...
func NewTemplate(serverInfos []serverInfo, setting *configure.Setting) (t *Template, err error) {
	...
	// add spare tire outbound routing. Fix: https://github.com/v2rayA/v2rayA-lib4/issues/447
